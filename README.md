...
Hosted:  https://ncnewstimdowd.herokuapp.com/api
...
6. Run the 'start' script to start running the server locally
...
- /api/articles:
  ...
  - GET:
    ...
    ```
      ...
      "COLUMN": "article_id", "title", "body", "votes", "topic", "author", "created_at", "comment_count"
      "ORDER": "asc" or "desc"
...
- /api/articles/:article_id/comments
  ...
  - GET:
    Description: Returns an object holding an array of comments related to the article
    ...
    - Query Example:
      https://localhost:9090/api/articles/:article_id/comments?sort_by=[COLUMN]&order=[ORDER]
